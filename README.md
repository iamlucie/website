...
| **AI Support** | GitHub Copilot (code), Claude Code (brand, skill docs), Cursor (research, analysis) |
| **VCS** | GitHub |
...
* **UI Icons:** Adapted from the asset ecosystem provided by [All-Icons.Carrd.co](https://all-icons.carrd.co/).
